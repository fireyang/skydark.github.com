...
7. 第一章第一次选择后无限循环。(常见被人叫作“十年循环”)
    ...
    ii) 如果你在使用 Symbian 版本的 ONS，应有两个版本的 ONS，一个对声音支持有问题，一个不支持 GBK——很有可能就是你在用的这个。没有特别好的办法——除了下面一段说的那个方法。
...
4. 打开自动阅读模式
    ...
    A: 最新脚本已无此问题。在旧脚本中，默认的自动阅读(右键菜单中的 Auto)和跳过功能是一样的，是我个人的历史遗留问题。
